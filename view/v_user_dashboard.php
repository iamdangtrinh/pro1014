        ...
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?=$base_url?>page/shop">Cửa Hàng</a></li>
            ...
            <div class="tab-pane fade show" id="account" role="tabpanel">
                <div class="order-content">
                    ...
                    <div class="order-table-container">
                        <form action="<?=$base_url?>user/update_info" method="post" enctype="multipart/form-data">
                            <div class="mb-2">
                    ...
                    <div class="order-table-container">
                        <form action="<?=$base_url?>user/update_pass" method="post">
                            <div class="mb-2">
                                ...
                                <input type="password" name="password" class="form-input form-wide" id="">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input type="password" name="re_password" class="form-input form-wide" id=""
                                    value="">
                            </div>
                            <input type="submit" name="btn_update_pass" value="Đổi mật khẩu"
                                class="btn btn-dark btn-md w-100">
                        </form>
            ...
            <div class="tab-pane fade" id="download" role="tabpanel">
                <div class="order-content">
                    ...
                    <div class="order-table-container text-center">
                        ...
                        <a href="<?=$base_url?>page/shop" class="btn btn-dark">Đến cửa hàng</a>
                    </div>
                </div>
            </div><!-- End .tab-pane -->
