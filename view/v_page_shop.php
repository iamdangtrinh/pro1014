                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 text-center">
                                <img src="<?= $base_url ?>upload/banners/category-banner.png" alt="banner" width="267" height="241">
                            </div>
                                                        ...
                                                        ?>
                                                                ...
                                                                <div class="collapse show" id="widget-category-<?= $i ?>">
                                                                    <ul class="cat-sublist">
                                                                        <li><a href="<?= $base_url ?>category/detail/<?= $item_dm['MaDM'] ?>"><?= $item_dm['TenDM'] ?><span class="products-count"></span></a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                    </li>
                                            ...
                                            <div class="product-default left-details product-widget">
                                                <figure>
                                                    <a href="<?= $base_url ?>product/detail/<?= $sp['MaSP'] ?>">
                                                        <img src="<?= $base_url ?>upload/products/<?= $sp['AnhSP']; ?>" width="75" height="75" alt="product" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                                    <h3 class="product-title">
