!(function () {
  ...
  function L(t) {
    ...
    (n = o === t.f.serif && a === t.f["sans-serif"]) || (n = B() && O(t, o, a)),
      n
        ? e() - t.A >= t.w
          ? B() && O(t, o, a) && (null === t.u || t.u.hasOwnProperty(t.a.c))
            ? D(t, t.v)
            : D(t, t.B)
          : (function (t) {
              setTimeout(
              ...
              null === q &&
                (q =
                  ...
                  (!(d = /Gecko.*Firefox\/(\d+)/.exec(
                    ...
                    42 < parseInt(d[1], 10))),
              (p = q
                ? new W(i(n.g, n), i(n.h, n), n.c, l, n.s, u)
                : new F(i(n.g, n), i(n.h, n), n.c, l, n.s, t, u)),
              h.push(p);
          }
  ...
  function R(t, n, i) {
    (this.c = t || n + U), (this.a = []), (this.f = []), (this.g = i || "");
  }
  ...
  var tt = { Arimo: !0, Cousine: !0, Tinos: !0 };
  function nt(t, n) {
    (this.c = t), (this.a = n);
  }
  function it(t, n) {
        ...
        if (2 <= e.length) {
          ...
          if (((s = []), (r = e[1])))
            for (var r, f = (r = r.split(",")).length, c = 0; c < f; c++) {
              var h;
              if ((h = r[c]).match(/^[\w-]+$/))
                if (null == (u = Y.exec(h.toLowerCase()))) h = "";
                else {
                  if (
                    ((h = null == (h = u[2]) || "" == h ? "n" : X[h]),
                    null == (u = u[1]) || "" == u)
                  )
                    u = "4";
                  else
          ...
          (i.__webfontfontdeckmodule__[n] = function (n, i) {
            for (var o = 0, a = i.fonts.length; o < a; ++o) {
              ...
              e.a.push(
                new y(
                  s.name,
                  _("font-weight:" + s.weight + ";font-style:" + s.style)
                )
              );
            }
            t(e.a);
