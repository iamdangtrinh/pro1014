!(function (t) {
  ...
  (i.prototype = {
    ...
    (t.fn.numerator = function (e) {
      return this.each(function () {
        t.data(this, "plugin_numerator") &&
          t.data(this, "plugin_numerator", null),
          t.data(this, "plugin_numerator", new i(this, e));
      });
    });
});
