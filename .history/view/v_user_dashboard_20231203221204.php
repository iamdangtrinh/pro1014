                    ...
                    <div class="order-table-container">
                        <form action="#" id="form_login" method="post">
                            <div class="mb-2">
                                ...
                                <input disabled type="password" name="password" class="form-input form-wide" id="password"
                                    value="<?php echo (isset($_SESSION['user'])) ? $_SESSION["user"]["Email"] : "" ?>">
                            </div>

                            <div class="mb-2">
                                <label for="new_password">Mật khẩu mới<span class="required">*</span></label>
                                <input type="pass" name="new_password" class="form-input form-wide" id="new_password"
                                    value="<?php echo (isset($_SESSION['user'])) ? $_SESSION["user"]["Email"] : "" ?>">
                            </div>

                            <div class="mb-2">
                                <label for="new_password">Nhập lại mật khẩu<span class="required">*</span></label>
                                <input type="password" name="email" class="form-input form-wide" id="login-email"
                                    value="<?php echo (isset($_SESSION['user'])) ? $_SESSION["user"]["Email"] : "" ?>">
                            </div>
