        ...
        <div class="row">
            <div class="col-lg-5 col-md-6 product-single-gallery">
                ...
                <div class="prod-thumbnail owl-dots">
                    <div class="owl-dot">
                        <img src="<?= $base_url ?>upload/products/<?= $product_detail['AnhSP'] ?>" width="110"
                            height="110" alt="product-thumbnail" />
                    </div>
                    <div class="owl-dot">
                        <img src="<?= $base_url ?>upload/products/<?= $product_detail['AnhSP1'] ?>" width="110"
                            height="110" alt="product-thumbnail" />
                    </div>
                    <div class="owl-dot">
                        <img src="<?= $base_url ?>upload/products/<?= $product_detail['AnhSP2'] ?>" width="110"
                            height="110" alt="product-thumbnail" />
                    </div>
                    <div class="owl-dot">
                        <img src="<?= $base_url ?>upload/products/<?= $product_detail['AnhSP3'] ?>" width="110"
                            height="110" alt="product-thumbnail" />
                    </div>
                    <div class="owl-dot">
                        <img src="<?= $base_url ?>upload/products/<?= $product_detail['AnhSP4'] ?>" width="110"
                            height="110" alt="product-thumbnail" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7 col-md-6 product-single-details">
                ...
                <div class="price-box">
                    ...
                    <?php else: ?>
                    <div class="price-box">
                        <span class="old-price"><?= number_format($product_detail['Gia'], 0, ",", ".") ?>đ</span>
                        <span
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="product-tab-size" data-toggle="tab" href="#product-size-content" role="tab"
                        aria-controls="product-size-content" aria-selected="true">Hướng dẫn chọn
                        kích
                        thước</a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" id="product-tab-tags" data-toggle="tab" href="#product-tags-content" role="tab"
                        aria-controls="product-tags-content" aria-selected="false">Thêm vào
                        Thông tin</a>
                </li>
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="product-tab-desc" data-toggle="tab"
                                            href="#product-desc-content" role="tab" aria-controls="product-desc-content" <div class="product-single-tabs">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="product-tab-desc" data-toggle="tab"
