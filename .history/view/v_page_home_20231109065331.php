            <section class="intro-section mb-3">
                <div class="home-slider slide-animate owl-carousel owl-theme" data-owl-options="{
                    ...
                    <div class="home-slide-1 banner">
                        <img class="slide-bg" src="<?=$base_url?>upload/1.png" alt="slider image" width="1200"
                            height="575">
                    ...
                    <div class="home-slide-2 banner">
                        <img class="slide-bg" src="<?=$base_url?>upload/2.png" alt="slider image" width="1200"
                            height="575">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-8 col-lg-6">
                            <div class="banner banner1 mb-2 appear-animate" data-animation-name="fadeIn"
                                ...
                                <figure>
                                    <img src="<?=$base_url?>upload/demoes/demo23/banners/banner-1.jpg" alt="banner"
                                        width="580" height="374">
                                </figure>
                        ...
                        <div class="col-md-4 col-lg-3">
                            <div class="banner banner2 mb-2 appear-animate" data-animation-name="fadeIn"
                                ...
                                <figure>
                                    <img src="<?=$base_url?>upload/demoes/demo23/banners/banner-2.jpg" alt="banner"
                                        width="280" height="374">
                                </figure>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="banner banner3 mb-2 appear-animate" data-animation-name="fadeIn"
                                ...
                                <figure>
                                    <img src="<?=$base_url?>upload/demoes/demo23/banners/banner-3.jpg" alt="banner"
                                        width="280" height="374">
                                </figure>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="banner banner4 mb-2 appear-animate" data-animation-name="fadeIn"
                                ...
                                <figure>
                                    <img src="<?=$base_url?>upload/demoes/demo23/banners/banner-4.jpg" alt="banner"
                        ...
                        <div class="col-md-4 col-lg-3">
                            <div class="banner banner5 mb-2 appear-animate" data-animation-name="fadeIn"
                                ...
                                <figure>
                                    <img src="<?=$base_url?>upload/demoes/demo23/banners/banner-5.jpg" alt="banner"
                                        width="280" height="374">
                                </figure>
                        ...
                        <div class="col-md-8 col-lg-6">
                            <div class="banner banner6 mb-2 appear-animate" data-animation-name="fadeIn"
                                ...
                                <figure>
                                    <img src="<?=$base_url?>upload/demoes/demo23/banners/banner-6.jpg" alt="banner"
                                        width="280" height="374">
                                </figure>
                        ...
                        <div class="categories-slider owl-carousel owl-theme" data-owl-options="{
                            ...
                            <div class="product-category" style="background-color: #d8dfe1;">
                                <a href="demo23-shop.html">
                                    <figure>
                                        <img src="<?=$base_url?>upload/demoes/demo23/products/cats/cat-1.jpg"
                            ...
                            <div class="product-category" style="background-color: #ebeae9;">
                                <a href="demo23-shop.html">
                                    <figure>
                                        <img src="<?=$base_url?>upload/demoes/demo23/products/cats/cat-2.jpg"
                                            alt="cat banner" width="500" height="400">
                                    </figure>
                            ...
                            <div class="product-category" style="background-color: #ead7d5;">
                                <a href="demo23-shop.html">
                                    <figure>
                                        <img src="<?=$base_url?>upload/demoes/demo23/products/cats/cat-3.jpg"
                                            alt="cat banner" width="500" height="400">
                                    </figure>
            ...
            <div class="brands-section">
                <div class="container">
                    ...
                    'responsive': {
                        ...
                        <img src="<?=$base_url?>upload/demoes/demo23/brands/brand1.png" width="200" height="50"
                            alt="brand">
                        <img src="<?=$base_url?>upload/demoes/demo23/brands/brand2.png" width="200" height="50"
                            alt="brand">
                        <img src="<?=$base_url?>upload/demoes/demo23/brands/brand3.png" width="200" height="50"
                            alt="brand">
                        <img src="<?=$base_url?>upload/demoes/demo23/brands/brand4.png" width="200" height="50"
                            alt="brand">
                        <img src="<?=$base_url?>upload/demoes/demo23/brands/brand5.png" width="200" height="50"
                            alt="brand">
