                ...
                <div class="order-content">
                    ...
                    <div class="order-table-container">
                        <form action="<?=$base_url?>user/update_info" id="form_info" method="POST">
                            <div class="mb-2">
                                <label for="login-name">Tên tài khoản<span class="required">*</span> (Tên hiện tại: <?php echo (isset($_SESSION['user'])) ? $_SESSION["user"]["HoTen"] : "" ?> )</label>
                                <input type="text" name="name" class="form-input form-wide" id=""
                                    value="">
                            </div>

                            <div class="mb-2">
                                <label for="login-email">Địa chỉ email<span class="required">*</span>(Bạn không thể thay đổi Email)</label>
                                <input disabled type="email" name="email" class="form-input form-wide" id=""
                                    value="<?php echo (isset($_SESSION['user'])) ? $_SESSION["user"]["Email"] : "" ?>">
                            </div>

                            <div class="mb-2">
                                <label for="login-password">Số điện thoại<span class="required">*</span> (Số điện thoại hiện tại: <?php echo (isset($_SESSION['user'])) ? $_SESSION["user"]["SoDienThoai"] : "" ?>)</label>
                                <input type="number" name="password" class="form-input form-wide" id=""
                                    value="">
                            </div>
                            <div class="mb-2">
                                <label for="address">Địa chỉ giao hàng<span class="required">*</span> (Địa chỉ hiện tại: <?php echo (isset($_SESSION['user'])) ? $_SESSION["user"]["DiaChi"] : "" ?>)</label>
