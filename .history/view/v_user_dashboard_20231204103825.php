    ...
    <div class="row">
        <div class="sidebar widget widget-dashboard mb-lg-0 mb-3 col-lg-3 order-0">
            ...
            <ul class="nav nav-tabs list flex-column mb-0" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="order-tab" data-toggle="tab" href="<?=$base_url?>user/info" role="tab"
                ...
                <div class="order-content">
                    ...
                    <div class="order-table-container">
                        <form action="<?=$base_url?>user/update_info" id="form_info" method="POST">
                            ...
                            <input type="submit" name="btn_update_info" value="Cập nhật tài khoản" title="Cập nhật tài khoản"
