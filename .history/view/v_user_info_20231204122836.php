                ...
                <div class="order-content">
                    ...
                    <div class="order-table-container">
                        <form action="<?=$base_url?>user/update_info" id="form_info" method="POST">
                            <div class="mb-2">
                                <label for="login-name">Tên tài khoản<span class="required">*</span> (Tên hiện tại: <?php echo (isset($_SESSION['user'])) ? $_SESSION["user"]["Email"] : "" ?> )</label>
                            ...
                            <div class="mb-2">
                                <label for="login-password">Số điện thoại<span class="required">*</span> (Số điện thoại hiện tại: )</label>
