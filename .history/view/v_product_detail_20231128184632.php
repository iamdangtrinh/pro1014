                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-6 product-single-details">
                            ...
                            <div class="product-action">
                                ...
                                <a href="<?=$base_url?>page/add" class="btn btn-dark add-cart mr-2" title="Thêm vào giỏ hàng">Thêm vào
                                    giỏ hàng </a>

                                <a href="<?=$base_url?>page/cart" class="btn btn-gray view-cart d-none" title="Xem giỏ hàng">Xem giỏ hàng</a>
                            </div>
                            <!-- End .product-action -->
