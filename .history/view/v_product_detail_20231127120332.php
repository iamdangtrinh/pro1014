                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-6 product-single-gallery">
                            ...
                            <div class="prod-thumbnail owl-dots">
                                <div class="owl-dot">
                                    <img src="<?=$base_url?>upload/demoes/demo23/products/<?=$product_detail['AnhSP']?>" width="110" height="110"
                                        alt="product-thumbnail" />
                                </div>
                                <div class="owl-dot">
                                    <img src="<?=$base_url?>upload/demoes/demo23/products/<?=$product_detail['AnhSP1']?>" width="110" height="110"
                                        alt="product-thumbnail" />
                                </div>
                                <div class="owl-dot">
                                    <img src="<?=$base_url?>upload/demoes/demo23/products/<?=$product_detail['AnhSP2']?>" width="110" height="110"
                                        alt="product-thumbnail" />
                                </div>
                                <div class="owl-dot">
                                    <img src="<?=$base_url?>upload/demoes/demo23/products/<?=$product_detail['AnhSP3']?>" width="110" height="110"
                                        alt="product-thumbnail" />
                                </div>
                                <div class="owl-dot">
                                    <img src="<?=$base_url?>upload/demoes/demo23/products/<?=$product_detail['AnhSP4']?>" width="110" height="110"
                                        alt="product-thumbnail" />
                                </div>
                            </div>
                        </div>
