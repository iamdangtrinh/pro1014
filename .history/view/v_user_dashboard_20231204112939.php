    ...
    <div class="row">
        <div class="sidebar widget widget-dashboard mb-lg-0 mb-3 col-lg-3 order-0">
            ...
            <ul class="nav nav-tabs list flex-column mb-0" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?=$base_url?>user/info" role="tab"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?=$base_url?>user/history" role="tab"
                    ...
                    <div class="row row-lg active">
                        <div class="col-6 col-md-4 ">
                            <div class="feature-box text-center pb-4">
                                <a href="<?=$base_url?>user/info" class="link-to-tab"><i class="fa-regular fa-user"></i></a>
                        ...
                        <div class="col-6 col-md-4">
                            <div class="feature-box text-center pb-4">
                                <a href="<?=$base_url?>user/password" class="link-to-tab"><i class="fa-solid fa-lock"></i></a>
                                <div class="feature-box-content">
                                    <h3>ĐỔI MẬT KHẨU</h3>
                                </div>
                            </div>
                        ...
                        <div class="col-6 col-md-4">
                            <div class="feature-box text-center pb-4">
                                <a href="<?=$base_url?>user/password" class="link-to-tab"><i
            ...
            <div class="tab-pane fade show" id="account" role="tabpanel">
                <div class="order-content">
                    ...
                    <div class="order-table-container">
                        <form action="<?=$base_url?>user/info" id="form_info" method="POST">
                            <div class="mb-2">
