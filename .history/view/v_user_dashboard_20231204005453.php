                    ...
                    <div class="order-table-container">
                        <form action="#" id="form_change_password" method="post">
                            <div class="mb-2">
                                ...
                                <input disabled type="text" name="password" class="form-input form-wide" id=""
                            ...
                            <div class="mb-2">
                                ...
                                <input type="email" name="email" class="form-input form-wide" id=""
                                    value="">
                            </div>

                            <div class="mb-2">
                                <label for="login-">Nhập lại mật Khẩu<span class="required">*</span></label>
                                <input type="email" name="email" class="form-input form-wide" id=""
                                    value="">
                            </div>
