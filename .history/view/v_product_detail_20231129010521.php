                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-6 product-single-details">
                            ...
                            <ul class="single-info-list">
                                ...
                                <form action="<?=$base_url?>wishli/addtowishlist" method="post">
                                    <input name="MaSP" type="hidden" value="<?=$product_detail['MaSP']?>">
                                    <input type="submit" class="btn-icon-wish add-wishlist" title="Thêm vào danh sách yêu thích"
                                     value="Yêu thích" name="btn_addtowishlist">
                                </form>
