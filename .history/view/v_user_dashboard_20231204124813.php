...
<div class="container account-container custom-account-container p-3">
    <div class="row">
        ...
        <div class="col-lg-9 order-lg-last order-1 tab-content">
            ...
            <div class="tab-pane fade actice show" id="download" role="tabpanel">
                <div class="order-content">
                    <h3 class="account-sub-title d-none d-md-block">
            ...
            <div class="tab-pane fade active show" id="billing" role="tabpanel">
            ...
            <div class="tab-pane fade active" id="shipping" role="tabpanel">
                <div class="address account-content mt-0 pt-2">
