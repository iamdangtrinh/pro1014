                        ...
                        <div class="col-lg-7 col-md-6 product-single-details">
                            ...
                            <div class="price-box">
                                ...
                                <div class="product-single-share mb-2">
                                    ...
                                    <!-- End .social-icons -->
                                    <form action="<?=$base_url?>page/wishlist" method="post">
                                            <input type="submit" class="btn-icon-wish add-wishlist" name="btn_addtowishlist" value="Đã thêm sản phẩm vào yêu thích">
                                    </form>
