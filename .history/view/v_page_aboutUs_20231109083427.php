            ...
            <div class="features-section bg-gray">
            	<div class="container">
            		<h2 class="subtitle">TẠI SAO CHỌN CHÚNG TÔI</h2>
            		<div class="row">
            			<div class="col-lg-4">
            	...
            	<div class="container">
            		...
            		<div class="testimonials-carousel owl-carousel owl-theme images-left" data-owl-options="{
            			...
            			<div class="testimonial">
            				...
            				<blockquote>
            					<p>Tại <strong><i>Cửa hàng bé yêu</i></strong>, chúng tôi không chỉ kinh doanh, chúng tôi tạo ra một cộng đồng, một nơi bạn có thể tìm kiếm những sản phẩm tốt nhất cho em bé của mình. Tôi là một người cha và hiểu rằng việc chăm sóc và lựa chọn quần áo cho bé là một phần quan trọng trong việc nuôi dạy con cái.</p>
            				</blockquote>
            			</div><!-- End .testimonial -->
