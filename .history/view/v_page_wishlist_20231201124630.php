                ...
                <tr class="product-row">
                    ...
                    <td>
                        <figure class="product-image-container">
                            ...
                            <a href="<?=$base_url?>page/delete_wishlist/<?= $product['MaSP']?>" class="btn-remove" title="Xóa sản phẩm"><i class="fa-solid fa-xmark"></i></a>
                        </figure>
                    </td>
                    <td>
                    ...
                    <td class="price-box"><?= $product['GiaGiam'] ?>đ</td>
                    <td>
