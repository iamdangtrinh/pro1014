            <div class="page-header page-header-bg text-left"
				style="background: 50%/cover #D4E1EA url('<?=$base_url?>upload/page-header-bg.jpg');">
				<div class="container">
			...
			<div class="about-section">
				<div class="container">
					...
					<p>Sự ra đời của [Tên Trang Web] không bắt nguồn từ việc kinh doanh, mà là kết quả của tình yêu và sự chăm sóc cho trẻ em. Chúng tôi là những người cha và mẹ, và chúng tôi luôn tìm kiếm những sản phẩm tốt nhất cho con cái của mình. Tuy nhiên, việc tìm kiếm quần áo chất lượng cho em bé thường gặp khó khăn.

Chúng tôi quyết định tạo ra [Tên Trang Web] để giải quyết vấn đề này. Chúng tôi muốn tạo ra một nơi mà các bậc phụ huynh có thể tìm thấy những món đồ tốt nhất cho con cái mình, mà không cần phải lo lắng về chất lượng hoặc giá cả.</p>
