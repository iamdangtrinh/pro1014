...
if (isset($_GET['act'])) {
    switch ($_GET['act']) {
        ...
        case 'info':
            ...
            $info_user = user_getInfo($_POST['MaTK']);
            $title = 'Thông tin tài khoản';
            $view_name = 'user_info';
            break;
        case 'password':
            include_once 'view/v_user_password.php';
            $title = 'Mật khẩu';
            $view_name = 'user_password';
            break;
        case 'history':
            include_once 'view/v_user_history.php';
            $title = 'Mật khẩu';
            $view_name = 'user_password';
            break;
        case 'update_info':
            include_once 'model/m_user.php';
            // đưa về page cũ
            // đổi session sang post tương ứng với cái name từng input
            // action về đúng 
