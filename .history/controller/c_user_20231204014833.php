    ...
    switch ($_GET['act']) {
        ...
        case 'update_info':
            ...
            if(isset($_POST['btn_update_info']) && $_POST['btn_update_info']){
                ...
                $DiaChi = $_POST['DiaChi'];
                $user_update_info = user_update_info($MaTK,$SoDienThoai, $Email, $HoTen, $MatKhau, $DiaChi,$VaiTro);
                if (empty($HoTen) || empty($SoDienThoai) || empty($DiaChi)){
                    ...
                    user_update_info($MaTK,$SoDienThoai, $Email, $HoTen, $MatKhau, $DiaChi,$VaiTro);
